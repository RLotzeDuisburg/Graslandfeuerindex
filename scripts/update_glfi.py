#!/usr/bin/env python3
"""Holt den DWD-Graslandfeuerindex (Station 13670) und schreibt data/glfi.json."""
import csv
import gzip
import json
import os
...
SOURCE_URL = (
    ...
    "fire_danger_index/grassland/forecast/recent/"
    f"derived_germany_fire_danger_index_grassland_forecast_recent_{STATION_ID}_v2-0--0.csv.gz"
)
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "glfi.json")


def fetch_latest_row():
    req = urllib.request.Request(SOURCE_URL, headers={"User-Agent": "glfi-widget/1.0"})
